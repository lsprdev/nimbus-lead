...
export function normalizeList(record: Partial<LeadList>): LeadList {
  return {
    ...
    segment_icon: record.segment_icon ? String(record.segment_icon) : undefined,
    segment_color: record.segment_color ? String(record.segment_color) : undefined,
    segment_pinned: Boolean(record.segment_pinned ?? false),
