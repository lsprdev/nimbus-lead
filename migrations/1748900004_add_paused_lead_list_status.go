...
func init() {
	m.Register(func(app core.App) error {
		...
		if !hasSelectValue(selectField.Values, "paused") {
			selectField.Values = append(selectField.Values, "paused")
		...
		records, err := app.FindRecordsByFilter("lead_lists", "status = 'paused'", "", 10000, 0)
		if err != nil {
			return err
		}
